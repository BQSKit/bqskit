...
from bqskit.passes.control import WhileLoopPass, ChangePredicate, WidthPredicate, IfThenElsePass, ForEachBlockPass
...
from bqskit.utils.typing import is_integer, is_real_number
...
class IterativeScanningGateRemovalPass(PassAlias):
    ...
    Repeat this until the circuit no longer changes. This will partition
    the circuit first if the circuit width is too large.
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.passes = [WhileLoopPass(ChangePredicate(),
            [
                IfThenElsePass(
