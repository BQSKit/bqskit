...
class UnitaryMeta(abc.ABCMeta):
    ...
    def __instancecheck__(cls, instance: Any) -> bool:
        ...
        Additional check for LocallyOptimizableUnitary. We check if the
        object has the is_locally_optimizable callable, an instance method
        that maps nothing to a bool. If the object has the method, then it
        must return true for isinstance to pass.
