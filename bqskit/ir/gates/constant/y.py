...
class YGate(QuditGate):
    """
    The one-qudit Y[i,j] gate. This gate is equivalent to a Pauli Y gate on the subspace of levels i,j. 
    """
    ...
    def __init__(
        ...
        """
            ...
            level_1 (int): the first level for the Y qudit gate (<num_levels)
            level_2 (int): the second level for the Y qudit gate (<num_levels)
