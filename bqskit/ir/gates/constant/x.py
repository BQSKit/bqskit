...
class XGate(QuditGate):
    """
        The one-qudit X[i,j] gate.
        This gate is equivalent to a Pauli X gate on the subspace of levels i,j.
    ...
    def get_unitary(self) -> UnitaryMatrix:
        ...
        matrix[self.level_1,self.level_2] = 1.0
        matrix[self.level_2,self.level_1] = 1.0
