...
class CCXGate(ConstantGate, QutritGate):
    """The toffoli gate, equal to an X gate with two controls User need to
    specify the state (0,1,2) of the control qutrit."""
...
class CCX01Gate(ConstantGate, QutritGate):
    """The CCX01 gate, equal to an X gate with two controls User need to specify
    the state (0,1,2) of the control qutrit."""
...
class CCX02Gate(ConstantGate, QutritGate):
    """The CCX02 gate, equal to an X gate with two controls User need to specify
    the state (0,1,2) of the control qutrit."""
...
class CCX12Gate(ConstantGate, QutritGate):
    """The CCX12 gate, equal to an X gate with two controls User need to specify
    the state (0,1,2) of the control qutrit."""
