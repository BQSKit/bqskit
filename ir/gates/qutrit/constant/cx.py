...
class CNOTGate(ConstantGate, QutritGate):
    """The Controlled-Not or Controlled-X gate for qutrits User need to specify
...
class CX01Gate(ConstantGate, QutritGate):
    """The Controlled-X01 gate for qutrits User need to specify the state
    (0,1,2) of the control qutrit."""
...
class CX02Gate(ConstantGate, QutritGate):
    """The Controlled-X02 gate for qutrits User need to specify the state
    (0,1,2) of the control qutrit."""
...
class CX12Gate(ConstantGate, QutritGate):
    """The Controlled-X12 gate for qutrits User need to specify the state
    (0,1,2) of the control qutrit."""
