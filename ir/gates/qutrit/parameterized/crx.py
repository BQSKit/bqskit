...
from bqskit.ir.gates.qutrit import jaxcgate, pdict
class CRX01Gate(
    QutritGate,
    ...
    def _unitary(self, params):
        return jaxcgate(params[0],jax.scipy.linalg.expm(-1j*params[1]*self.x))
    
    def _unitary_diff(self, params):
        return jax.numpy.kron(pdict[params[0]],jax.scipy.linalg.expm(-1j*params[1]*self.x))
